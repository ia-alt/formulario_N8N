...
export const camposPadroes = {
  obrigatorios: [
    { nome: "Nome Completo", tipo: "text", obrigatorio: true },
    { nome: "CPF", tipo: "text", obrigatorio: true },
    { nome: "Email", tipo: "email", obrigatorio: true },
    { nome: "Nascimento", tipo: "date", obrigatorio: true },
  ],
  naoObrigatorios: [{ nome: "Telefone", tipo: "tel", obrigatorio: false }],
};

export const publicosAlvos = [
  { value: "Alunos" },
  { value: "Professores" },
  { value: "Servidores" },
];
